...
export default function PayslipsPage() {
  ...
  //       if (selectedYear === currentYear) return m.value <= currentMonth + 1;
  //       return false;
  //     });
  ...
  //           if (res?.data) results.push(res.data);
  //         } catch {
  //           // 404 — month has no payslip yet, skip silently
  //         }
  //       }),
  //     );
  ...
  //       return m.value <= currentMonth + 1; // include up to one month ahead
  //     });
  ...
  //           if (res?.data) results.push(res.data);
  //         } catch {
  //           // 404 = no payslip yet for this month, skip silently
  //         }
  //       }),
  //     );
