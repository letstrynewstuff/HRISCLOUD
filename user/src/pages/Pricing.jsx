...
console.log("Pricing.jsx loaded successfully");
console.log("handleSpotlightMove:", handleSpotlightMove);
console.log("bg_blue4:", bg_blue4);
...
export default function Pricing() {
  ...
  console.log("Current billing cycle:", cycle);
  console.log("FAQ currently open:", openFaq);
    ...
    <div className="overflow-x-hidden bg-white font-body text-brand-ink">
      ...
      <section className="relative overflow-hidden bg-[linear-gradient(180deg,#EEF2FF_0%,#F4F5FC_45%,#FFFFFF_100%)] px-6 pt-40 pb-24">
        ...
        <div className="relative z-[1] mx-auto max-w-[1180px]">
          ...
          <p className="mt-8 text-center text-sm leading-[1.7] text-brand-ink-muted">
            All plans include onboarding by our team at no extra cost. No setup
            fee, and no long-term lock-in — cancel anytime.
          </p>
        </div>
      </section>
