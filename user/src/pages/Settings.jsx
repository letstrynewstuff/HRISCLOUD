        ...
        <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
          ...
          <main className="flex-1 overflow-y-auto p-5 md:p-7">
            ...
            <div className="flex flex-col lg:flex-row gap-6">
              {/* Left nav */}
              {/* <div
                className="lg:w-72 bg-white rounded-2xl border p-3 h-fit"
                style={{ borderColor: C.border }}
              >
                  ...
                  {SECTIONS.map(({ id, icon: Icon, live }) => (
                    ...
                    <motion.button
                      ...
                      style={{
                        ...
                        color:
                          activeSection === id ? C.primary : C.textSecondary,
                      }}
                    >
              ...
              >
                <div className="space-y-1">
                  {SECTIONS.map((section) => {
                    const { id, icon: Icon, live } = section;
                  ...
                  {activeSection === "Notifications" && (
                    <div>
                      <p
                        ...
                        style={{ color: C.textMuted }}
                      >
                        Choose how you'd like to receive notifications for each
                        event.
                      </p>
                      ...
                      {prefsLoading ? (
                        ...
                        <div>
                          ...
                          >
                            ...
                            <div
                              className="flex gap-6 text-xs font-bold uppercase tracking-wide"
                              style={{ color: C.textMuted }}
                            >
      ...
      <AnimatePresence>
        {toast && (
          <Motion.div
            ...
            style={{
              borderColor: toast.type === "error" ? C.danger : C.successLight,
            }}
          >
            {toast.type === "error" ? (
