...
// const RECIPIENT_EMAIL = "demo@hriscloud.ng"; 
        ...
        >
          ...
          <div style={{ flex: 1 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              ...
              {[
                { emoji: "⚡", text: "Live payroll run in under 2 minutes" },
                { emoji: "📋", text: "Employee self-service portal demo" },
                { emoji: "📊", text: "Real-time HR analytics dashboard" },
                { emoji: "💬", text: "Built-in team chat & announcements" },
                { emoji: "📄", text: "Digital document signing workflow" },
              ].map(({ emoji, text }) => (
                <div
                  key={text}
