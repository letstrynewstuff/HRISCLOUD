...
//       score:    appraisal.hrRatings?.length ? (r.score ?? 0) : 0, // reset scores if seeding from manager
//       comment:  appraisal.hrRatings?.length ? (r.comment ?? "") : "",
//     }));
//   });

//   const [hrFeedback,    setHrFeedback]    = useState(appraisal.hrFeedback ?? "");
//   // hrScoreWeight: what % of the blended score comes from HR (default 20)
//   const [hrScoreWeight, setHrScoreWeight] = useState(appraisal.hrScoreWeight ?? 20);
//   const [skipHrRating,  setSkipHrRating]  = useState(false); // HR can choose to trust manager fully
...
//   // const hrOverall      = skipHrRating
//   //   ? managerOverall  // HR trusts manager fully
//   //   : (computeWeighted(hrRatings) ?? managerOverall);
