...
// Thin router that switches between the report list and report detail,
// same pattern as your other admin pages (e.g. employees, departments).
// All the real logic lives in ReportsListView / ReportDetailView.
    ...
    >
      <div className="max-w-5xl mx-auto">
        {selectedReportId ? (
          ...
          <ReportsListView onViewReport={(id) => setSelectedReportId(id)} />
        )}
      </div>
    </div>
  );
