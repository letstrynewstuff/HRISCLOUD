...
export const GRADE_CONFIG = {
  L7: { color: "#F59E0B", bg: "#FEF3C7", label: "Executive" },
  L6: { color: "#6366F1", bg: "#EEF2FF", label: "Director" },
  L5: { color: "#4F46E5", bg: "#EEF2FF", label: "Senior" },
  L4: { color: "#6366F1", bg: "#E0E7FF", label: "Mid-Level" },
  L3: { color: "#047857", bg: "#D1FAE5", label: "Junior" },
  L2: { color: "#94A3B8", bg: "#F0F2F8", label: "Entry" },
};
