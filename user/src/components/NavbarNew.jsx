...
//             {/* Mobile Close 'X' Button - Only shows on screens smaller than 'md' */}
//             {setSidebarOpen && (
//               <button
...
//                   onClick={() => setSidebarOpen?.(false)} // Auto-closes sidebar on mobile when a link is clicked
//                 >
//                   {({ isActive }) => (
//                     <Motion.div
...
//               )}
//             </NavLink>
//             <NavLink to="/help" onClick={() => setSidebarOpen?.(false)}>
//               {({ isActive }) => (
//                 <div
//                   className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm"
//                   style={{
