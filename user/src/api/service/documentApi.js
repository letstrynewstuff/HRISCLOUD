...
//   /**
//    * Step 1 — Upload a raw PDF or DOCX file.
//    * @param {File}   file     — the File object from an <input type="file">
//    * @param {string} name     — human-readable document name
//    * @param {string} category — e.g. "Contract", "NDA", "Offer Letter" …
...
//   /**
//    * Step 2 — Assign the uploaded document to one or more employees and send
//    *          for signature. Triggers an in-app notification for each employee.
//    * @param {string}   documentId  — id returned from uploadFile()
//    * @param {string[]} employeeIds — array of employee UUIDs
//    * @param {string}   [message]   — optional personal message from the admin
