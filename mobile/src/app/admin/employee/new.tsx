...
import StepIndicator from "../../../components/admin/employee/AddEmployeeStepIndicator";
...
export default function AddEmployeeScreen() {
  ...
  const renderStep1 = () => (
    <View style={s.stepContent}>
      ...
      {/* CHANGED: Free-text location instead of hardcoded dropdown */}
  ...
  const renderStep4 = () => (
    <View style={s.stepContent}>
      ...
      {/* CHANGED: Free-text bank name instead of hardcoded dropdown */}
              ...
              <View style={s.modalActions}>
                <Pressable
                  onPress={() => {
                    ...
                    router.push(
                      `/admin/employees/profile/${createdEmployee?.id}` as any,
                    );
                  }}
                  style={({ pressed }) => [
                    s.modalPrimaryBtn,
                ...
                >
                  <Text style={s.modalPrimaryBtnText}>View Employee</Text>
                </Pressable>
